...
def lda_analysis(review):
    """
    In dieses Funktioniert als erstes ein neues Dictionary, BOW  und ID2Word erstellt.
    Anschließend werden 8 LDA Modelle erstellt 
    und von diesen der Cohrence Score berechnet und als CSV gespeichert.
    Da die Ergebnisse die Anzahl 3 als gut zurückgegeben wird, 
    anschließend ein SDA Model mit 3 Themen aufgestellt.
    Das Ergebnisse dieses Models wird als CSV gespeichert,
    die wichtigsten Thema geprintet und anschließend wird dieses Model zurückgeben.
    """
    word_array = []
    for r in review:
